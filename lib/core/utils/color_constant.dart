...
class ColorConstant {
  ...
  static Color gray606 = fromHex('#6f6f6f');

  static Color gray600 = fromHex('#828282');

  static Color gray402 = fromHex('#bcbcbc');
  ...
  static Color gray401 = fromHex('#c9c9c9');

  static Color gray604 = fromHex('#787878');

  static Color gray802 = fromHex('#4b4b4b');

  static Color gray605 = fromHex('#7e7e7e');

  static Color gray800 = fromHex('#424242');

  static Color gray602 = fromHex('#737373');

  static Color gray603 = fromHex('#7b7878');
  ...
  static Color bluegray402 = fromHex('#898989');

  static Color bluegray401 = fromHex('#868686');
  ...
  static Color gray507 = fromHex('#929292');
  ...
  static Color gray103 = fromHex('#f2fff4');

  static Color gray500 = fromHex('#9a9a9a');

  static Color gray901 = fromHex('#14171f');

  static Color gray505 = fromHex('#adadad');

  static Color gray703 = fromHex('#5c5c5c');

  static Color gray506 = fromHex('#989898');

  static Color gray902 = fromHex('#1a1a1a');

  static Color gray701 = fromHex('#5e5e5e');

  static Color gray503 = fromHex('#9b9b9b');

  static Color gray900 = fromHex('#14171e');

  static Color gray702 = fromHex('#646464');

  static Color gray504 = fromHex('#a2a2a2');
